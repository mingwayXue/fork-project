...
import com.xue.xblog.business.entity.Tags;
import com.xue.xblog.business.entity.User;
import com.xue.xblog.business.enums.ArticleStatusEnum;
import com.xue.xblog.business.service.BizArticleService;
import com.xue.xblog.business.service.BizArticleTagsService;
import com.xue.xblog.business.service.BizTagsService;
import com.xue.xblog.business.service.RemoverService;
import com.xue.xblog.business.service.SysConfigService;
import com.xue.xblog.business.util.ImageDownloadUtil;
import com.xue.xblog.framework.exception.ZhydException;
import com.xue.xblog.spider.model.Article;
import com.xue.xblog.spider.model.BaseModel;
import com.xue.xblog.spider.processor.ArticleSpiderProcessor;
import com.xue.xblog.spider.processor.BaseSpider;
import com.xue.xblog.spider.util.WriterUtil;
import com.xue.xblog.spider.webmagic.ZhydSpider;
...
//        List<Tags> tags = tagsService.listAll();
        ...
        // 添加文章到数据库
        com.xue.xblog.business.entity.Article article = null;
        // 处理标签，并获取最终待添加的标签id
        ...
        for (Article spiderArticle : list) {
            ...
            article = new com.xue.xblog.business.entity.Article();
