    ...
    <div class="row">
        ...
        <div class="col-sm-12 blog-main">
            <div class="blog-body expansion">
                ...
                <div class="info">
                    本站为非商业化站点，无盈利性质，为博主个人博客。本站二次开发于 <a href="https://github.com/mingwayXue/XBlog" title="" data-toggle="tooltip" data-placement="right" target="_blank" data-original-title="XBlog是一款简洁美观Java博客系统..."><strong>XBlog</strong></a>。<br>
                </div>
                <h5 class="legend-title">关于版权</h5>
                <div class="info">
                    本站所有标注为原创的文章，转载请标明出处。<br>
                    本站所有转载的文章，一般都会在文章中注明原文出处。<br>
                    所有转载的文章皆来源于互联网，若因此对原作者造成侵权，烦请原作者<a target="_blank" href="mailto:571025297@qq.com" title="点击给我发邮件" data-toggle="tooltip" data-placement="bottom" rel="external nofollow"><strong>告知</strong></a>，我会立刻删除相关内容。
                </div>
