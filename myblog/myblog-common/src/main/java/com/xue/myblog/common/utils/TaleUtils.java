package com.xue.myblog.common.utils;
...
public class TaleUtils {
     ...
     * 上传文件名前缀
     */
    public static final String File_CLASSPATH = TaleUtils.getUploadFilePath();
...
//            默认是classPath路径
    ...
    public static String getFileKey(String name) {
        ...
        if (!new File(File_CLASSPATH + prefix).exists()) {
            new File(File_CLASSPATH + prefix).mkdirs();
        }
