...
public class ArticleController extends BaseController {
    ...
    @GetMapping(value = "/showArticleByCname/{cname}")
    public String showArticleByCname(@PathVariable String cname, HttpServletRequest request) {
        PageInfo<ContentVo> contentsPaginator = contentsService.getArticleByCname(cname, 1, 50);
        request.setAttribute("articles", contentsPaginator);
        return "admin/article_list";
    }
}
