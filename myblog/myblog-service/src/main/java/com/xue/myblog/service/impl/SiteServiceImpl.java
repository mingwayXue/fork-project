package com.xue.myblog.service.impl;

import com.github.pagehelper.PageHelper;
import com.xue.myblog.common.constant.WebConst;
import com.xue.myblog.dao.AttachVoMapper;
import com.xue.myblog.dao.CommentVoMapper;
import com.xue.myblog.dao.ContentVoMapper;
import com.xue.myblog.dao.MetaVoMapper;
import com.xue.myblog.entity.dto.MetaDto;
import com.xue.myblog.entity.dto.Types;
import com.xue.myblog.common.exception.TipException;
import com.xue.myblog.entity.Bo.ArchiveBo;
import com.xue.myblog.entity.Bo.BackResponseBo;
import com.xue.myblog.entity.Bo.StatisticsBo;
import com.xue.myblog.entity.Vo.*;
import com.xue.myblog.service.ISiteService;
import com.xue.myblog.common.utils.DateKit;
import com.xue.myblog.common.utils.TaleUtils;
import com.xue.myblog.common.utils.ZipUtils;
import com.xue.myblog.common.utils.backup.Backup;
...
public class SiteServiceImpl implements ISiteService {
    ...
    private static final String FILE_CLASSPATH = TaleUtils.getUploadFilePath();
    ...
    public BackResponseBo backup(String bk_type, String bk_path, String fmt) throws Exception {
        ...
        if (bk_type.equals("attach")) {
            ...
            String bkAttachDir = FILE_CLASSPATH + "upload";
            String bkThemesDir = FILE_CLASSPATH + "templates/themes";
