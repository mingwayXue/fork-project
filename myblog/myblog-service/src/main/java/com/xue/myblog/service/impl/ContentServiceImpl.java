...
import com.xue.myblog.entity.Vo.ContentVo;
import com.xue.myblog.entity.Vo.ContentVoExample;
import com.xue.myblog.service.IContentService;
import com.xue.myblog.service.IMetaService;
import com.xue.myblog.service.IRelationshipService;
import com.xue.myblog.common.utils.DateKit;
import com.xue.myblog.common.utils.TaleUtils;
import com.xue.myblog.common.utils.Tools;
...
//            原来的重复校验没有生效，在此修改一下
    ...
    @Override
    public PageInfo<ContentVo> getArticleByCname(String cname, Integer page, Integer limit) {
        PageHelper.startPage(page, limit);

        //对 cname 模糊查询操作添加
        cname = "%" + cname + "%";
        List<ContentVo> contentVos = contentDao.findByCname(cname);
        return new PageInfo<>(contentVos);
    }
}
