...
public interface SerialNumberMapperEx {
    ...
    /**
     * 卖出： update serial_number set is_Sell='1' ,depothead_Id='depotheadId' where 1=1 and material_Id='materialId'
    ...
    /**
     * 赎回：update serial_number set is_Sell='0'  where 1=1 and material_Id='materialId'
